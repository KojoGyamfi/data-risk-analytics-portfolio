...
class Price(Base):
    ...
    commodity = Column(String(50), nullable=False)   # e.g. "POWER", "GAS"
    region = Column(String(50), nullable=False)      # e.g. "DE-LU", "US"
    contract = Column(String(100), nullable=False)   # e.g. "Day-Ahead Baseload", "Henry Hub Spot"
    ...
    source = Column(String(100), nullable=False)     # e.g. "ENTSOE_API", "EIA_API"
